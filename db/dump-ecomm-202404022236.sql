...
CREATE TABLE `sales` (
  ...
  `payer_postcode` varchar(20) NOT NULL,
  `payer_tel` varchar(20) NOT NULL,
  `payer_content` text,
  `receiver_fname` varchar(50) NOT NULL,
  `receiver_lname` varchar(50) NOT NULL,
  `receiver_email` varchar(100) NOT NULL,
  `receiver_address` varchar(255) NOT NULL,
  `receiver_postcode` varchar(20) NOT NULL,
  `receiver_tel` varchar(20) NOT NULL,
  `receiver_content` text,
  `sale_status` enum('pending','confirmed','shipped','delivered','cancelled') NOT NULL DEFAULT 'pending',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-02 22:36:53
...
INSERT INTO `users` ( `email`, `password`, `type`, `firstname`, `lastname`, `address`, `contact_info`, `photo`, `status`, `created_on`) VALUES
('admin@admin.com', '$2y$10$8wY63GX/y9Bq780GBMpxCesV9n1H6WyCqcA2hNy2uhC59hEnOpNaS', 1, 'Lyndon', 'Bermoy', '', '', 'profile youtube1.jpg', 1, '2018-05-01');
